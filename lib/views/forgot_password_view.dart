      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: Column(
            children: [
              const Text(
                  "If you forgot your password, simpy enter your email and we will send you a password reset link."),
              TextField(
              ...
              TextButton(
                ...
                child: const Text("Send new password reset link"),
              ),
              TextButton(
                onPressed: () {
                  context.read<AuthBloc>().add(const AuthEventLogOut());
                },
                child: const Text("Back yo login page"),
              ),
            ],
          ),
        ),
